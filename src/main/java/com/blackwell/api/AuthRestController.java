...
public class AuthRestController {
    ...
    public UserSummary getCurrentUser(@PathVariable String username, @CurrentUser UserPrincipal currentUser) throws UnauthorizedUserException {
        if (currentUser == null || !StringUtils.equals(username, currentUser.getUsername())) {
            throw new UnauthorizedUserException();
        }

        return new UserSummary(currentUser.getId().toString(), currentUser.getUsername());
    }
